...
//  Added by gle on 25 Nov 2016 to support Neo-Pixel display

      case  NEO_PIXEL:   NeoPixelDisplay() ;
                         mem->command.status = COMPLETED ; 
                         break ;
...
// down M2 and speed up M1!!!!
   ...
   velDiff = rightVel - leftVel - mem->setpointPID.sp ;  
