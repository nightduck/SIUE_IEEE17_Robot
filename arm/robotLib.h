...
//If true, move commands in robotLib will block program flow until completed
//If false, other computations allowed while movement taking place
//Use (query(STATUS) == COMPLETED) to detect when movement over
#define   BLOCK		FALSE
